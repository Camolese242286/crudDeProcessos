...
function NovoProcesso() {
  ...
  useEffect(() => {
    if (id) {
      ...
      if (processo) {
        ...
        const primeiraOpcao = Object.keys(processo.questoesPorTipo || {})[0] || "";
  ...
  const handleAdicionarQuestao = () => {
    ...
    const novaQuestao = {
      ...
      resposta: "",
      tipo: SelectedOption,
      itens: SelectedOption === "CheckList" ? [{ text: "", checked: false }] : [], //Inicializa itens para checklist
    };
    ...
    <>
      ...
      <div className="container">
        ...
        <div className="prioridade">
          <select className="selectPrioridade" value={prioridades} onChange={(e) => setPrioridade(e.target.value)}>
            <option value="">Selecione a prioridade do processo</option>
        ...
        <div className="opcoes-processo">
          <select className="selectOpcoes" onChange={handleOptionChange}>
            <option value="">Selecione a opção do Processo</option>
        ...
        <div className="questoes-container">
                      ...
                      <div key={idx} className="checklist-item">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleAtualizarChecklistCheckbox(questao.id, idx, e.target.checked)
                          }}
                        ...
                        <input
                          ...
                          value={item.text || ""}
                          onChange={(e) =>
                            handleAtualizarChecklistText(questao.id, idx, e.target.value)
                          }
          ...
          <div className="btn-botoes">
            ...
            <div className="btn-salvar-enviar">
              <button onClick={handleAbrirPopup} className="salvar-enviar">Salvar e enviar</button>
