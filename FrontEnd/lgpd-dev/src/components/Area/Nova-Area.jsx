...
function NovaArea({ onClose, area, onSaveArea }) {
  ...
  const [editandoNomeArea, setEditandoNomeArea] = useState(false);
          ...
          <div className="container-area">
            ...
            <div className="container-title-description">
              <input
                ...
                onFocus={() => setEditandoNomeArea(true)}
                onBlur={() => setEditandoNomeArea(false)}
              />
              <textarea
